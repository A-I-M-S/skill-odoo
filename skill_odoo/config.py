...
The original standalone skill-odoo also used this loader; the Telegram-related
settings that lived next to these in the reference repo's ``config.py`` are
gone — they only existed to feed the long-polling bot, which we dropped.
"""
